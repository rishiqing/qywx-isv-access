...
public interface CorpService {
     ...
     * @return
     */
    void activeCorp(String authCode) throws UnirestException, HttpException;
     ...
     * @return
     */
    CorpVO fetchAndSaveCorpInfo(SuiteTokenVO suiteTokenVO, CorpSuiteVO corpSuite) throws UnirestException, HttpException;
     ...
     */
    CorpVO fetchAndChangeCorpInfo(SuiteTokenVO suiteToken, CorpSuiteVO corpSuite) throws UnirestException, HttpException;
