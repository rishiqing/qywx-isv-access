...
//    public RequestClient(String path, Map<String, Object> queryMap, Map<String, Object> fieldMap, String body) {
//        this.path = path;
...
//    }
//
//    public RequestClient(String path, Map<String, Object> queryMap, Map<String, Object> fieldMap, String body, Map<String, String> options) {
//        this.path = path;
//        this.queryMap = queryMap;
//        this.fieldMap = fieldMap;
//        this.body = body;
...
//    }
     ...
     */
    public JSONObject post(String path, Map<String, Object> queryMap, Map<String, Object> fieldMap, String body, Map<String, String> options) throws UnirestException, HttpException {
        ...
        if(errcode != null && !errcode.equals(0L)){
            if(errcode.equals(42009L) || errcode.equals(40082L)){
                ...
                logger.warn("RequestClient post suiteAccessToken expired, trying to fetch again, errcode: {}", errcode);
                ...
                logger.warn("RequestClient post corpAccessToken expired, trying to fetch again, errcode: {}", errcode);
                String corpToken = this.fetchAndSaveCorpAccessToken(options.get("corpId"));
    ...
    public JSONObject get(String path, Map<String, Object> queryMap, Map<String, String> options) throws UnirestException, HttpException {
        ...
        if(errcode != null && !errcode.equals(0L)){
            if(errcode.equals(42009L) || errcode.equals(40082L)){
                //  如果遇到suiteAccessToken失效，重新获取suiteAccessToken
                logger.warn("RequestClient get suiteAccessToken expired, trying to fetch again, errcode: {}", errcode);
                String suiteToken = this.fetchAndSaveSuiteAccessToken();
                queryMap.put("suite_access_token", suiteToken);
                return this.get(path, queryMap, options);
            }else if(errcode.equals(42001L) || errcode.equals(40014L)){
                //  如果遇到corpAccessToken失效，重新获取corpAccessToken
                logger.warn("RequestClient get corpAccessToken expired, trying to fetch again, errcode: {}", errcode);
                String corpToken = this.fetchAndSaveCorpAccessToken(options.get("corpId"));
                queryMap.put("access_token", corpToken);
                return this.get(path, queryMap, options);
            }else{
     ...
     */
    private String fetchAndSaveSuiteAccessToken() throws UnirestException, HttpException {
        ...
        HttpResponse<String> resp =
                Unirest.post(RequestUrl.SUITE_ACCESS_TOKEN)
     ...
     * @throws HttpException
     */
    private String fetchAndSaveCorpAccessToken(String corpId) throws UnirestException, HttpException {
        String suiteKey = (String)isvGlobal.get("suiteKey");
        ...
        HttpResponse<String> resp =
                Unirest.post(RequestUrl.CORP_ACCESS_TOKEN)
