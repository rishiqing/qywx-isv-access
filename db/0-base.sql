...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='套件信息表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='用于接收推送的套件ticket';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='套件的accesstoken表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT 'isv创建的app';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='企业对套件的授权记录';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='企业微应用信息表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='套件能够访问企业数据的accesstoken';
...
(
  ...
  AUTO_INCREMENT = 2
  DEFAULT CHARSET = utf8mb4 COMMENT ='isv存储的公司部门信息';
...
(
  ...
  AUTO_INCREMENT = 2
  DEFAULT CHARSET = utf8mb4 COMMENT ='isv存储的公司成员信息';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='企业使用jsapi的js ticket表';
...
ALTER TABLE isv_corp_app
  DROP INDEX u_corp_app;
ALTER TABLE isv_corp_app
  ADD UNIQUE u_corp_app (`suite_key`, `corp_id`);
...
(
  ...
  AUTO_INCREMENT = 36
  DEFAULT CHARSET = utf8mb4 COMMENT ='企业对套件的授权失败记录';
...
(
  ...
  AUTO_INCREMENT = 36
  DEFAULT CHARSET = utf8mb4 COMMENT ='企业通讯录事件回调失败的记录';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='套件的预授权码表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='企业的标签';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='企业中用户与标签的关联表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='企业中部门与标签的关联表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='服务商发送消息的表';

# add isv_corp columns

ALTER TABLE `isv_corp`
  ADD COLUMN `corp_scale` varchar(255) NULL COMMENT '企业规模';
ALTER TABLE `isv_corp`
  ADD COLUMN `corp_industry` varchar(255) NULL COMMENT '企业所属行业';
ALTER TABLE `isv_corp`
  ADD COLUMN `corp_sub_industry` varchar(255) NULL COMMENT '企业所属子行业';

# 授权开通应用的管理员信息
ALTER TABLE `isv_corp_suite`
  ADD COLUMN `auth_user_id` varchar(255) NULL COMMENT '授权开通应用的管理员id';
ALTER TABLE `isv_corp_suite`
  ADD COLUMN `auth_user_name` varchar(255) NULL COMMENT '授权开通应用的管理员的名称';
ALTER TABLE `isv_corp_suite`
  ADD COLUMN `auth_user_avatar` varchar(255) NULL COMMENT '授权开通应用的管理员的头像';

#add 2019-02-14 付费功能
CREATE TABLE `isv_qywx_order`
(
  `id`              bigint(20)   NOT NULL AUTO_INCREMENT COMMENT '主键',
  `date_created`    datetime     NOT NULL COMMENT '创建时间',
  `last_updated`    datetime     NOT NULL COMMENT '修改时间',
  `orderid`         varchar(64)  NOT NULL COMMENT '订单id',
  `order_status`    varchar(32) COMMENT '订单状态。0-未支付，1-已支付，2-已关闭， 3-未支付且已过期， 4-申请退款中， 5-申请退款成功',
  `order_type`      varchar(32) COMMENT '订单类型。0-普通订单，1-扩容订单，2-续期，3-版本变更',
  `paid_corpid`     varchar(128) NOT NULL COMMENT '购买该套件企业的corpid',
  `operator_id`     varchar(32) COMMENT '下单操作人员userid',
  `suiteid`         varchar(100) NOT NULL COMMENT '用户购买套件的SuiteKey',
  `appid`           varchar(100) DEFAULT NULL COMMENT '用户购买套件的SuiteKey',
  `edition_id`      varchar(256) NOT NULL COMMENT '购买版本ID',
  `edition_name`    varchar(256) NOT NULL COMMENT '购买版本名字',
  `price`           bigint(10)   NOT NULL COMMENT '实付款金额，单位分',
  `user_count`      bigint(10) COMMENT '订购的具体人数',
  `order_period`    bigint(20)   NOT NULL COMMENT '购买的时间，单位天',
  `order_time`      bigint(20)   NOT NULL COMMENT '下单时间（尚未付款），单位秒',
  `paid_time`       bigint(20)   DEFAULT NULL COMMENT '付款时间，单位秒',
  `changed_orderid` varchar(64) COMMENT '改单之后新订单id',
  `charge_status`   varchar(32) COMMENT '充值到日事清的状态',
  `charge_time`     datetime COMMENT '充值成功的时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `isv_order_unique_order_id` (`orderid`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='订单表（按照企业微信的数据格式）';
...
(
  ...
  `item_code`        varchar(256) NOT NULL COMMENT '购买版本ID',
  `item_name`        varchar(256) NOT NULL COMMENT '购买版本名字',
...
(
  ...
  `service_stop_time` bigint(20)   NOT NULL COMMENT '该订单的服务到期时间，单位毫秒！',
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='发送到日事清的事件表';
...
(
  ...
  `current_order_id`          varchar(64) COMMENT '订单id',
  `current_goods_code`        varchar(256) DEFAULT NULL COMMENT '购买的商品码',
  `current_item_code`         varchar(256) DEFAULT NULL COMMENT '购买版本ID',
  ...
  `current_service_stop_time` bigint(20) COMMENT '当前订单的服务到期时间，单位毫秒！',
  `status`                    varchar(32)  NOT NULL COMMENT '公司状态',
  PRIMARY KEY (`id`),
  UNIQUE KEY `isv_corp_charge_status_unique_corp_id` (`suite_key`, `corp_id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='公司充值状态表';

#add 2019-02-03 新增可见范围变更的版本字段
ALTER TABLE `isv_corp`
